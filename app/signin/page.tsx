      ...
      <div className="absolute top-6 left-10 z-50 flex justify-between items-center">
        ...
        <div className="absolute left-[1306px] flex items-center md:gap-3 gap-6">
          {socialMedia.map(info => (
            ...
            >
              <Link href={info.link} target="_blank" className='hover:scale-105 transition-all duration-300'>
                <Image src={info.img} alt="icons" width={20} height={20} />
              </Link>
            </div>
          ))}
          <Link href="https://volodymyrcodepro.site/" target="_blank" className='hover:scale-110 transition-all duration-300'>
